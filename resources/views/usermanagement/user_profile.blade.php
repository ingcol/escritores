        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="pcoded-hasmenu ">
                ...
                <li class="pcoded-hasmenu active pcoded-trigger" dropdown-icon="style1" subitem-icon="style1">
                    ...
                    <ul class="pcoded-submenu">
                        <li class="">
                            <a href="{{ route('form/product/new') }}">
                                <span class="pcoded-mtext">Product</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="{{ route('form/product/list/new') }}">
                                <span class="pcoded-mtext">Product List</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="{{ route('form/product/edit/new') }}">
                                <span class="pcoded-mtext">Product Edit</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="{{ route('form/product/detail/new') }}">
                                <span class="pcoded-mtext">Product Detail</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="{{ route('form/product/card/new') }}">
                                <span class="pcoded-mtext">Product Card</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="{{ route('form/credit/card/new') }}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="social-wallpaper">
                                                        <img src="{{URL::to('assets/files\assets\images\social\img1.jpg')}}" class="img-fluid width-100" alt="">
                                                    ...
                                                    <div class="social-timeline-left">
                                                        ...
                                                        <div class="card">
                                                            <div class="social-profile">
                                                                <img class="img-fluid width-100" src="{{URL::to('assets/files\assets\images\social\profile.jpg')}}" alt="">
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-block user-box">
                                                                ...
                                                                <img class="media-object img-radius" src="{{URL::to('assets/files\assets\images\avatar-1.jpg')}}" alt="Generic placeholder image" data-toggle="tooltip" data-placement="top" title="user image">
                                                                ...
                                                                <div class="media m-b-10">
                                                                    <a class="media-left" href="#!">
                                                                <img class="media-object img-radius" src="{{URL::to('assets/files\assets\images\avatar-2.jpg')}}" alt="Generic placeholder image" data-toggle="tooltip" data-placement="top" title="user image">
                                                                ...
                                                                <div class="media m-b-10">
                                                                    <a class="media-left" href="#!">
                                                                <img class="media-object img-radius" src="{{URL::to('assets/files\assets\images\avatar-3.jpg')}}" alt="Generic placeholder image" data-toggle="tooltip" data-placement="top" title="user image">
                                                                <div class="live-status bg-danger"></div>
                                                            </a>
                                                                    <div class="media-body">
                                                                        <div class="chat-header">Josephin Doe</div>
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-block friend-box">
                                                                <img class="media-object img-radius" src="{{URL::to('assets/files\assets\images\avatar-1.jpg')}}" alt="" data-toggle="tooltip" data-placement="top" title="user image">
                                                                <img class="media-object img-radius" src="{{URL::to('assets/files\assets\images\avatar-2.jpg')}}" alt="" data-toggle="tooltip" data-placement="top" title="user image">
                                                                <img class="media-object img-radius" src="{{URL::to('assets/files\assets\images\avatar-3.jpg')}}" alt="" data-toggle="tooltip" data-placement="top" title="user image">
                                                                <img class="media-object img-radius" src="{{URL::to('assets/files\assets\images\avatar-4.jpg')}}" alt="" data-toggle="tooltip" data-placement="top" title="user image">
                                                                <img class="media-object img-radius" src="{{URL::to('assets/files\assets\images\avatar-1.jpg')}}" alt="" data-toggle="tooltip" data-placement="top" title="user image">
                                                                <img class="media-object img-radius" src="{{URL::to('assets/files\assets\images\avatar-4.jpg')}}" alt="" data-toggle="tooltip" data-placement="top" title="user image">
                                                                <img class="media-object img-radius" src="{{URL::to('assets/files\assets\images\avatar-3.jpg')}}" alt="" data-toggle="tooltip" data-placement="top" title="user image">
                                                                <img class="media-object img-radius" src="{{URL::to('assets/files\assets\images\avatar-2.jpg')}}" alt="" data-toggle="tooltip" data-placement="top" title="user image">
                                                                        ...
                                                                        <div class="row timeline-right p-t-35">
                                                                            <div class="col-2 col-sm-2 col-xl-1">
                                                                                <div class="social-timelines-left">
                                                                                    <img class="img-radius timeline-icon" src="{{URL::to('assets/files\assets\images\avatar-2.jpg')}}" alt="">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-10 col-sm-10 col-xl-11 p-l-5 p-b-35">
                                                                                <div class="card">
                                                                                    ...
                                                                                    <img src="{{URL::to('assets/files\assets\images\timeline\img1.jpg')}}" class="img-fluid width-100" alt="">
                                                                                    ...
                                                                                    <div class="card-block user-box">
                                                                                        ...
                                                                                        <div class="media m-b-20">
                                                                                            <a class="media-left" href="#">
                                                                                        <img class="media-object img-radius m-r-20" src="{{URL::to('assets/files\assets\images\avatar-1.jpg')}}" alt="Generic placeholder image">
                                                                                    </a>
                                                                                        ...
                                                                                        <div class="media m-b-20">
                                                                                            <a class="media-left" href="#">
                                                                                        <img class="media-object img-radius m-r-20" src="{{URL::to('assets/files\assets\images\avatar-2.jpg')}}" alt="Generic placeholder image">
                                                                                    </a>
                                                                                            <div class="media-body b-b-muted social-client-description">
                                                                                        ...
                                                                                        <div class="media">
                                                                                            <a class="media-left" href="#">
                                                                                        <img class="media-object img-radius m-r-20" src="{{URL::to('assets/files\assets\images\user.png')}}" alt="Generic placeholder image">
                                                                                    </a>
                                                                                            <div class="media-body">
                                                                                                <form class="">
                                                                                                    <div class="">
                                                                        ...
                                                                        <div class="row timeline-right p-t-35">
                                                                            ...
                                                                            <div class="col-10 col-sm-10 col-xl-11 p-l-5 p-b-35">
                                                                                <div class="card">
                                                                                    ...
                                                                                    <img src="assets/files\assets\images\timeline\img1.jpg" class="img-fluid width-100" alt="">
                                                                                    <div class="card-block">
                                                                                        <div class="timeline-details">
                                                                                            <div class="chat-header">Josephin Doe posted on your timeline</div>
                                                                                            <p class="text-muted">lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                                                                    ...
                                                                                    <div class="card-block user-box">
                                                                                        ...
                                                                                        <div class="media m-b-20">
                                                                                            <a class="media-left" href="#">
                                                                                        <img class="media-object img-radius m-r-20" src="assets/files\assets\images\avatar-1.jpg" alt="Generic placeholder image">
                                                                                    </a>
                                                                                            <div class="media-body b-b-muted social-client-description">
                                                                                                <div class="chat-header">About Marta Williams<span class="text-muted">Jane 10, 2015</span></div>
                                                                                                <p class="text-muted">lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor
                                                                                        ...
                                                                                        <div class="media">
                                                                                            <a class="media-left" href="#">
                                                                                        <img class="media-object img-radius m-r-20" src="assets/files\assets\images\user.png" alt="Generic placeholder image">
                                                                                    </a>
                                                                                            <div class="media-body">
                                                                                                <form class="">
                                                                                                    <div class="">
                                                                ...
                                                                <div class="col-md-12 timeline-dot">
                                                                    <div class="social-timelines p-relative">
                                                                        <div class="row timeline-right p-t-35">
                                                                            <div class="col-2 col-sm-2 col-xl-1">
                                                                                <div class="social-timelines-left">
                                                                                    <img class="img-radius timeline-icon" src="assets/files\assets\images\avatar-2.jpg" alt="">
                                                                                </div>
                                                                            </div>
                                                                                ...
                                                                                <div class="col-lg-6 col-md-12">
                                                                                    <table class="table table-responsive m-b-0">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="social-user-name b-none text-muted"><a href="assets/assets/assets/cdn-cgi\l\email-protection.htm" class="__cf_email__" data-cfemail="e195849295a1868c80888dcf828e8c">[email&#160;protected]</a></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                        ...
                                                                        <div class="demo-gallery">
                                                                            <ul id="profile-lightgallery" class="row">
                                                                                <li class="col-md-4 col-lg-2 col-sm-6 col-xs-12">
                                                                                    <a href="assets/files\assets\images\light-box\l1.jpg" data-toggle="lightbox" data-title="A random title" data-footer="A custom footer text">
                                                                                <img src="assets/files\assets\images\light-box\sl1.jpg" class="img-fluid" alt="">
                                                                            </a>
                                                                                </li>
                                                                                <li class="col-md-4 col-lg-2 col-sm-6 col-xs-12">
                                                                                    <a href="assets/files\assets\images\light-box\l1.jpg" data-toggle="lightbox" data-title="A random title" data-footer="A custom footer text">
                                                                        ...
                                                                        <div class="card-block post-timelines">
                                                                            ...
                                                                            <div class="media bg-white d-flex">
                                                                                <div class="media-left media-middle">
                                                                                    <a href="#">
                                                                                <img class="media-object" src="assets/files\assets\images\timeline\img2.png" alt="">
                                                                            </a>
                                                                                </div>
