  ...
  <div id="app-sidepanel" class="app-sidepanel"> 
    ...
    <div class="sidepanel-inner d-flex flex-column">
      ...
      <div class="app-branding">
        <a class="app-logo" ><img class="logo-icon mr-2 img-fluid" src="https://image.freepik.com/vector-gratis/ilustracion-icono-logo-vector-marketing-digital_1893-1451.jpg" alt="logo"><span class="logo-text text-white">Llanotics</span></a>
        ...
        <ul class="app-menu list-unstyled accordion" id="menu-accordion">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/usuario">
              <span class="fa fa-users fa-icon">

              </span>
              <span class="nav-link-text text-white">Usuarios</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/empresa">
              ...
              <span class="nav-link-text text-white">Fundación</span>
            </a>
          </li>
          ...
          <li class="nav-item">
            ...
            <a class="nav-link" href="/slider">
              <span class="fa fa-sliders fa-icon">

              </span>
              <span class="nav-link-text text-white">Slider</span>
            </a><!--//nav-link-->
          </li><!--//nav-item-->

            <li class="nav-item">
            <a class="nav-link" href="/galeria">
              <span class="fa fa-image fa-icon">

              </span>
              <span class="nav-link-text text-white">Galería</span>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="/actividadAdmin">
              ...
              <span class="nav-link-text text-white">Actividades</span>
            </a>
          </li>
           ...
           <li class="nav-item">
            <a class="nav-link" href="/aliadoAdmin">
              ...
              <span class="nav-link-text text-white">Aliados</span>
            </a>
          </li>
